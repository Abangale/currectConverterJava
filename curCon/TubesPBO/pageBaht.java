...
public class pageBaht extends JPanel implements ActionListener {
    ...
    public pageBaht() {
        ...
        l1 = new JLabel("Input Mata Uang Baht");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //Convert to IDR
        if (source == b1) {
            double baht = Double.parseDouble(t1.getText());
            double usd = baht / rateBaht;
